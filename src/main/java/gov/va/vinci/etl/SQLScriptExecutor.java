...
public class SQLScriptExecutor implements Runnable {
    ...
    public static Logger LOGGER = Logger.getLogger(SQLScriptExecutor.class.getName());
    private String url;
    ...
    public static void main(String[] args) throws ParseException {
        ...
        new SQLScriptExecutor(id, name, dbConfigFile, sqlScriptFile).run();

    }

    public SQLScriptExecutor(int id, String name, String dbConfigFile, String sqlScriptFile) {
        init(id, name, dbConfigFile, sqlScriptFile);
    }

    public SQLScriptExecutor(String dbConfigFile, String sqlScriptFile) {
